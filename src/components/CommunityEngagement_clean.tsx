...
// Instagram embed component - sleek and minimal
function InstagramEmbedWithFallback({ post }: { post: CommunityPost }) {
  ...
  if (hasError) {
    ...
    return (
      <div className="w-full max-w-[400px] mx-auto h-[500px] flex flex-col items-center justify-center bg-gradient-to-br from-gray-900/50 to-gray-800/50 rounded-2xl border border-gray-700/50 backdrop-blur-sm">
        <div className="w-16 h-16 mb-4 rounded-full bg-gradient-to-tr from-pink-500 via-yellow-400 to-purple-500 opacity-60" />
        <p className="text-gray-300 text-sm font-light mb-3">Content unavailable</p>
        <a
          href={post.url}
          target="_blank"
  ...
  // Clean iframe embed with proper sizing
  return (
