...
The disaster struck Tallidas village in District Ghizer, Gilgit-Baltistan, when a glacial lake outburst flood (GLOF) was
...
triggered by the sudden breach of a glacier-dammed lake situated approximately nine kilometers upslope.
...
A warning sent out by a local shepherd helped to prevent the loss of life by ensuring timely evacuation of around 200 people, but the village now faces another threat. A large amount of debris has been accumulated by the flood, damming the Gilgit River and forming a 7-km long artificial lake. Satellite imagery of the affected areas show the accumulation of water threatening the residents nearby.
